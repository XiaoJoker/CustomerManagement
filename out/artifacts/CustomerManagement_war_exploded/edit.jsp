...
<form action="<c:url value='/CustomerServlet'/>" method="post" >
    ...
    <table border="0" align="center" width="40%" style="margin-left: 100px">
        ...
        <tr>
            <td>客户性别</td>
            <td>
                 <input type="radio" name="gender" value="男" id="male" <c:if test="${customer.gender eq 'male'}">checked="checked"</c:if>/>
                <label for="male">男</label>
                <input type="radio" name="gender" value="女" id="female" <c:if test="${customer.gender eq 'female'}">checked="checked"</c:if> />
